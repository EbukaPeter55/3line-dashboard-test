import {Role} from "@/features/dashboard/pages/shared/types/role-types";
import roleCardIcon from "../../../../../assets/dashboard/role-card-icon.png";
...
// Sample data for your "User Roles" table (uses the 'RoleTableData' type)
export const sampleRoleTableData: RoleTableData[] = [
    {
        id: 'table_role1',
        name: 'Superadmin',
        type: 'DEFAULT',
